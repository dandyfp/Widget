    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnAlert.setOnClickListener{
            AlertDialog.Builder(this).apply {
                ...
                {dialog,_->Toast.makeText(applicationContext,"Anda klik OK",Toast.LENGTH_SHORT).show()
                dialog.dismiss()
                }
                setNegativeButton("Back")
                {dialog,_->Toast.makeText(applicationContext,"Anda klik Back",Toast.LENGTH_SHORT).show()
                    dialog.dismiss()}
            }.show()
        }
